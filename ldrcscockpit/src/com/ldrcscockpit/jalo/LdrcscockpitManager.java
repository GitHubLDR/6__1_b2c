...
import com.ldrcscockpit.constants.LdrcscockpitConstants;
...
/**
 * This is the extension manager of the ldrcscockpit extension.
 */
public class LdrcscockpitManager extends GeneratedLdrcscockpitManager
{
	/**
	 * Edit the local|project.properties to change logging behavior (properties 'log4j.*').
	 */
	@SuppressWarnings("unused")
	private final static Logger LOG = Logger.getLogger(LdrcscockpitManager.class.getName());
	 ...
	 */
	public static final LdrcscockpitManager getInstance()
	{
		return (LdrcscockpitManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(LdrcscockpitConstants.EXTENSIONNAME);
	}
