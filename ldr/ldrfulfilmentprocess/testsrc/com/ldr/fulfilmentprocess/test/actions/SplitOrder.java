 ...
 *  
 */
package com.ldr.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(LdrFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(LdrFulfilmentProcessConstants.PARENT_PROCESS);
