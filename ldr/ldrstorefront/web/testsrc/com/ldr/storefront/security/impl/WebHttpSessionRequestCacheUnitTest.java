...
public class WebHttpSessionRequestCacheUnitTest
{
	...
	public void testCalcRedirectUrlWithEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ldrstorefront/electronics/en",
						"https://electronics.local:9002/ldrstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/en", "/ldrstorefront/electronics/en",
						"https://electronics.local:9002/ldrstorefront/electronics/en/"));
	...
	public void testCalcRedirectUrlWithMismatchEncodingAttrs()
	{
		assertEquals(
				"electronics/en",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ldrstorefront/electronics/ja/Y/Z",
						"https://electronics.local:9002/ldrstorefront/electronics/en"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("electronics/ja/Y/Z", "/ldrstorefront/electronics/en",
						"https://electronics.local:9002/ldrstorefront/electronics/en/"));
	}
	...
	public void testCalcRedirectUrlWithoutEncodingAttrs()
	{
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ldrstorefront",
						"https://electronics.local:9002/ldrstorefront"));
		assertEquals(
				"/",
				executeCalculateRelativeRedirectUrl("", "/ldrstorefront",
						"https://electronics.local:9002/ldrstorefront/"));
	...
	public void testCalcRedirectUrlWithEncodingAttrsServletPath()
	{
		assertEquals(
				...
				executeCalculateRelativeRedirectUrl("electronics/en", "/ldrstorefront/electronics/en",
						"https://electronics.local:9002/ldrstorefront/electronics/en/Open-Catalogue/Cameras/Digital-Cameras/c/575"));
	}
