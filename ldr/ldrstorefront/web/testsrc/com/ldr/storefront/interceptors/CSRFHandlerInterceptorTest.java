 ...
 *  
 */
package com.ldr.storefront.interceptors;
...
import com.ldr.storefront.util.CSRFHandlerInterceptor;
import com.ldr.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "com.ldr.storefront.util.CSRFTokenManager.tokenval";
