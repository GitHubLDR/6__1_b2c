 ...
 *
 */
package com.ldr.storefront.controllers.cms;
...
public class GenericCMSComponentController extends AbstractController
{
	...
	@Value("#{configurationService.configuration.getProperty('ldrstorefront.generic.cms.component.controller.authorized.group')}")
