 ...
 *
 */
package com.ldr.initialdata.setup;
...
import com.ldr.initialdata.constants.LdrInitialDataConstants;
 ...
 */
@SystemSetup(extension = LdrInitialDataConstants.EXTENSIONNAME)
public class InitialDataSystemSetup extends AbstractSystemSetup
{
	@SuppressWarnings("unused")
	private static final Logger LOG = Logger.getLogger(InitialDataSystemSetup.class);

	public static final String APPAREL = "ldrApparel";
	public static final String APPAREL_UK = "ldrApparel-uk";
	public static final String APPAREL_DE = "ldrApparel-de";
