...
import com.ldr.test.constants.LdrTestConstants;
import com.ldr.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = LdrTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/ldrtest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/ldrtest/import/reviews.impex");
			...
			importImpexFile(context, "/ldrtest/import/cstickets.impex");
		}
	}
}
