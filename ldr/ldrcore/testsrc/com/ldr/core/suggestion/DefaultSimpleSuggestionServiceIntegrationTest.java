 ...
 *  
 */
package com.ldr.core.suggestion;
...
import com.ldr.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/ldrcore/test/testSimpleSuggestionService.csv", "utf-8");
	}
