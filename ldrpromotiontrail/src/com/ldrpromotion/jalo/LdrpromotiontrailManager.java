...
import com.ldrpromotion.constants.LdrpromotiontrailConstants;



/**
 * This is the extension manager of the Ldrpromotiontrail extension.
 */
public class LdrpromotiontrailManager extends GeneratedLdrpromotiontrailManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LdrpromotiontrailManager.class.getName());
	 ...
	 */
	public static LdrpromotiontrailManager getInstance()
	{
		return (LdrpromotiontrailManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager().getExtension(
				LdrpromotiontrailConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LdrpromotiontrailManager() // NOPMD 
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LdrpromotiontrailManager called.");
		}
	}
	...
	public void init()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("init() of LdrpromotiontrailManager called. " + getTenant().getTenantID());
		}
	}
	...
	public void destroy()
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("destroy() of LdrpromotiontrailManager called, current tenant: " + getTenant().getTenantID());
		}
	}
