 ...
 */
package com.ldrbackoffice.jalo;
...
import com.ldrbackoffice.constants.LdrbackofficeConstants;
 ...
 */
public class LdrbackofficeManager extends GeneratedLdrbackofficeManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(LdrbackofficeManager.class.getName());
	 ...
	 */
	public static LdrbackofficeManager getInstance()
	{
		return (LdrbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(LdrbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public LdrbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of LdrbackofficeManager called.");
		}
	}
